    ...
    try:
        ...
        return {
            ...
            "result": {
                ...
                "trades": result.trades[:20],  # Erste 20 Trades
...
async def get_risk_status():
    """
    V2.3.31: Gibt den aktuellen Risiko-Status aller Broker zurück
    """
    try:
        from risk_manager import risk_manager, init_risk_manager
        from multi_platform_connector import multi_platform
        
        # Initialisiere Risk Manager falls nötig
...
async def assess_trade_risk(request: dict):
    """
    V2.3.31: Bewertet das Risiko eines geplanten Trades
...
async def get_available_strategies():
    """V2.3.31: Gibt verfügbare Strategien für Backtesting zurück"""
    return {
        "strategies": [
            {"id": "day_trading", "name": "Day Trading", "description": "Intraday Trades basierend auf RSI und Trend"},
            {"id": "swing_trading", "name": "Swing Trading", "description": "Mehrtägige Trades basierend auf Trendfolge"},
            {"id": "scalping", "name": "Scalping", "description": "Schnelle Trades bei kleinen Preisbewegungen"},
            {"id": "mean_reversion", "name": "Mean Reversion", "description": "Handel bei Überverkauft/Überkauft (Bollinger Bands)"},
            {"id": "momentum", "name": "Momentum", "description": "Trendfolge-Strategie"},
            {"id": "breakout", "name": "Breakout", "description": "Handel bei Ausbruch aus Trading-Range"},
            {"id": "grid", "name": "Grid Trading", "description": "Systematisches Kaufen/Verkaufen in Grid-Levels"}
        ],
        "commodities": [
